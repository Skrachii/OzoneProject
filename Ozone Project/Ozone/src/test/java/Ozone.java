...
public class Ozone {
    ...
    String filePath = "D:/DiscountedElements.txt";
...
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"cookie_info_agree\"]/a")));
        ...
        while (hasNextPage) {
            ...
            for (WebElement discountedPrice: discountedPrices) {
                discountedProducts.add(discountedPrice.getText());
            }
...
//            discountedProducts.addAll(discountedPrices);
        ...
        try (FileWriter writer = new FileWriter(filePath)) {
            for (String element : discountedProducts) {
                writer.write(element + "\n");
            }
            System.out.println("Elements saved successfully.");
        } catch (IOException e) {
